...
/**
 * UI con la información general de la aplicación.
 * @author Alicia Olivares Gil
 */
public class AboutActivity extends AppCompatActivity {

    /**
     * Construye la UI y genera los textos formateados.
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text3.setText("Este proyecto está alojado en la plataforma GitHub bajo la licencia AGPLv3: https://github.com/aog0036/TFG-SmartBeds");
        text4.setText(Html.fromHtml("- Android Support Library: Apache License 2.0"+"<br>"+"- MPAndroidChart: Apache License 2.0"+"<br>"+"- Gradle: Apache License 2.0"+"<br>"+"- Socket.IO-client Library: MIT License"));
    }
