...
/**
 * UI de visualización de gráficas de una cama.
...
public class BedChartsActivity extends AppCompatActivity {
    ...
    /**
     * Finaliza el activity y termina el hilo.
     */
    @Override
    ...
    /**
     * Construye la UI, crea las gráficas y gestiona las pestañas.
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Recupera los layouts del estado y las pestañas
        ...
        tabs.setOnTabSelectedListener(new TabLayout.BaseOnTabSelectedListener() {
            ...
            /**
             * Modifica la visibilidad de los elementos del UI en función de la pestaña seleccionada.
             * @param tab
             */
            @Override
        ...
        //Consulta el namespace de la cama y lanza el hilo para la comunicación en tiempo real
     ...
     * @param resultado JSONObject resultado de la petición.
     */
    public void refresh(JSONObject resultado) {
        ...
        //Se muestran como mucho 180 instancias de datos.
        if (counter > 180) {
            listProb.remove(0);
            listP1.remove(0);
            listP2.remove(0);
        ...
        //Se añaden los nuevos datos a las listas
    ...
    /**
     * Actualiza las gráficas de una sola línea
     * @param chart Gráfica
     * @param list Lista de datos a representar
     * @param dataSet Set de datos a representar
     * @param lineData Linea de datos
     * @param color Color de la línea
     * @param label Etiqueta de la línea de datos
     */
    ...
    /**
     * Actualiza la gráfica de presiones
     */
    ...
    /**
     * Actualiza una línea de la gráfica de presiones.
     * @param list Lista de datos a actualizar.
     * @param color Color de la línea.
    ...
    /**
     * Configura un nuevo gráfico.
     * @param chart Gráfico
     * @param count Número de particiones en el eje y. Si es igual a -1 los valores min y max se calculan dinámicamente.
     * @param min Mínimo valor en el eje y
     * @param max Máximo valor en el eje y
     */
    private void generateChart(LineChart chart, int count, int min, int max) {
        ...
        //Formateador de las etiquetas del eje x
        xAxis.setValueFormatter(new ValueFormatter() {
            /**
             * Devuelve la hora a partir del valor del contador.
             * @param value Valor del contador.
