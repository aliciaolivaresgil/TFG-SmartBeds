...
Este tipo de transformaciones supone que los datos observados son combinación lineal de una cierta base, y en ellas se engloba el Análisis de Componentes Principales (\textit{PCA})~\cite{pca}. 
