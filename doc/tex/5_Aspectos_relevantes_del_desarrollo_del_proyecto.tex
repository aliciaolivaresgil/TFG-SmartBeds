...
De esta forma aunque se pierda la conexión ssh, el proceso \texttt{jupyter nbconvert} seguirá corriendo en el equipo, y podremos acceder a los resultados una vez termine. 
