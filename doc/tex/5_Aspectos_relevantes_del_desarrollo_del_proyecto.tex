...
En la figura~\ref{fig:mobile_comparation} se comparan las valoraciones de los participantes con un perfil tecnológico con las de los participantes con un perfil no tecnológico (sanitario o educativo). Las valoraciones del perfil tecnológico son algo superiores que las del perfil no tecnológico, a excepción de la opinión global de la aplicación, que es muy buena en los dos casos. 
