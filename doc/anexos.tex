...
% Datos de portada
\title{SmartBeds\\[0.5cm]Aplicación de técnicas de minería de datos para detección de crisis epilépticas y aplicación Android.\\[0.5cm]Documentación Técnica}
\author{Alicia Olivares Gil}
\tutor{Álvar Arnaiz González y José Franciso Díez Pastor}
\date{\today}
