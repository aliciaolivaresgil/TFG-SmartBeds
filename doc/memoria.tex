...
% Datos de portada
\title{SmartBeds \\ [0.5cm]Aplicación de técnicas de minería de datos para detección de crisis epilépticas y aplicación Android}
\author{\nombre}
...
\begin{abstract}
Epilepsia, crisis, minería de datos, clasificador, tiempo real, series temporales, algoritmo genético, \textit{ensemble}, Android. 
\end{abstract}
...
\begin{abstract}
Epilepsy, seizure, data mining, classifier, real-time, time series, genetic algorithm, ensemble, Android.
\end{abstract}
