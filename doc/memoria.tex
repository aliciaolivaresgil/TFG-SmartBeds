...
% Datos de portada
\title{\huge{SmartBeds} \\ [0.5cm]Aplicación de técnicas de minería de datos para detección de crisis epilépticas}
\author{\nombre}
...
\noindent Que el alumno D. \nombre, con DNI 71299943N, ha realizado el Trabajo final de Grado en Ingeniería Informática titulado <<SmartBeds -- Aplicación de técnicas de minería de datos para la detección de crisis epilépticas>>. 
