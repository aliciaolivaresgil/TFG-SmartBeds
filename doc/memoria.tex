...
% Datos de portada
\title{\huge{SmartBeds} \\ [0.5cm]Aplicación de técnicas de minería de datos para detección de crisis epilépticas y aplicación Android.}
\author{\nombre}
...
\noindent Que el alumno D. \nombre, con DNI 71299943N, ha realizado el Trabajo final de Grado en Ingeniería Informática titulado <<SmartBeds -- Aplicación de técnicas de minería de datos para la detección de crisis epilépticas y aplicación Android>>. 
...
Adicionalmente, se desarrolla una aplicación de Android para mostrar la aplicabilidad de este modelo. 
\end{abstract}

\renewcommand*\abstractname{Descriptores}
\begin{abstract}
Epilepsia, crisis, minería de datos, clasificador, tiempo real, Android. 
\end{abstract}
...
Additionally, an Android application is developed to show the applicability of the model.
\end{abstract}

\renewcommand*\abstractname{Keywords}
\begin{abstract}
Epilepsy, seizure, data mining, classifier, real-time, Android.
\end{abstract}
